...
exploitation). There are many extensions of of the EXP3. EXP4, also proposed by
\cite{auer2002nonstochastic}, adds an extra layer of expert advice.
\cite{beygelzimer10}. We shall
test~\cite{seldin14}'s EXP3++ algorithm (see Algorithm~\ref{alg:exp3pp}). This
is a generalization of the original EXP3 and it has been shown to perform well
in both the stochastic (where the reward of each heuristic follows an unknown
reward distribution) and the adversarial regime.
