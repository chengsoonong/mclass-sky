...
$\Unlabeled \subset \X$. Finally we also need a separate test set $\Labelled_S
...
\begin{IEEEeqnarray}{lCl}
	r_{HE}(\bm{x}; h) &=& \argmin_{x \in \Unlabeled}
...
performance to decrease. In addition, even without any label noise, the
...
\begin{enumerate}
	...
	active leaners. The reasons are twofold. First, we do not have a
