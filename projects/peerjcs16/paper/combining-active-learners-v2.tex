...
More sophisticated batch-mode active learning approaches have been proposed
to take into account other factors such as the diversity of a batch and
the representiveness of each batch example. These approaches include looking at
the angles between hyperplanes in support vector machines \citep{brinker03},
using cluster analysis \citep{xu07}, and using an evolutionary algorithm
\citep{reyes18}. How to aggregate suggestions from these approaches is an
