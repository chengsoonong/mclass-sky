...
%DIF DEL combining-active-learners-v1.tex   Thu Jun  7 15:38:28 2018
%DIF ADD combining-active-learners-v2.tex   Sun Jun 10 10:45:47 2018
...
project\footnote{\DIFdelbegin \DIFdel{http}\DIFdelend \DIFaddbegin \DIFadd{https}\DIFaddend ://\DIFdelbegin \DIFdel{dx.}\DIFdelend doi.org/10.5281/zenodo.58500} \citep{alam15}. The
...
\begin{table}[htbp]
	...
	\begin{tabular}{lrrrrr}
		...
		\href{https://archive.ics.uci.edu/ml/datasets/Pima+Indians+Diabetes}{pima}
        	& $733$ & $2$ & $8$ & $66\%$ & $71\%$ \\
        \DIFdelbeginFL %DIFDELCMD < \href{http://dx.doi.org/10.5281/zenodo.58500}{sdss}
%DIFDELCMD <         	%%%
\DIFdelendFL \DIFaddbeginFL \href{https://doi.org/10.5281/zenodo.58500}{sdss}
        	\DIFaddendFL & $2~801~002$ & $3$ & $11$ & $61\%$ & $90\%$ \\
...
More sophisticated batch-mode active learning \DIFdelbegin \DIFdel{heuristics }\DIFdelend \DIFaddbegin \DIFadd{approaches }\DIFaddend have been proposed
\DIFdelbegin \DIFdel{,
...
}\DIFdelend \DIFaddbegin \DIFadd{to take into account other factors such as the diversity of a batch and
the representiveness of each batch example. These approaches include looking at
the angles between hyperplanes in support vector machines \mbox{%DIFAUXCMD
\citep{brinker03}}\hspace{0pt}%DIFAUXCMD
,
using cluster analysis \mbox{%DIFAUXCMD
\citep{xu07}}\hspace{0pt}%DIFAUXCMD
, and using an evolutionary algorithm
\mbox{%DIFAUXCMD
\citep{reyes18}}\hspace{0pt}%DIFAUXCMD
}\DIFaddend . How to aggregate suggestions from these \DIFdelbegin \DIFdel{heuristics }\DIFdelend \DIFaddbegin \DIFadd{approaches }\DIFaddend is an
