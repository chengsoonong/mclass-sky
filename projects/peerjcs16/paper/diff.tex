...
project\DIFaddbegin \footnote{\DIFadd{https://doi.org/10.5281/zenodo.58500}} \DIFaddend \citep{alam15}. The
...
%DIFDELCMD < %%%
\DIFdel{The SDSS dataset}\footnote{%DIFDELCMD < \url{https://doi.org/10.5281/zenodo.58500}%%%
} %DIFAUXCMD
\addtocounter{footnote}{-1}%DIFAUXCMD
\DIFdel{was
