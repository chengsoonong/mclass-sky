...
problem. The oldest of these is Thompson sampling, \citep{thompson33}, that
solves the trade-off from a Bayesian perspective. We also consider Optimally
Confident UCB \citep{lattimore15} and KL-UCB \citep{cappe13}, which were
...
combine the rankings. This leads us to Social Choice Theory. Originally
developed by political scientists like Condorcet, the theory is concerned with
how we aggregate preferences of a group of people to determine, for example,
the winner of an election. It has the nice property that everyone (or every
suggestion in our context) has a voice.
...
bandit algorithms such as Thompson samplis̄ng. In the absence of such a test set,
