...
\begin{table}[h]
	\caption {Example of Social Choice Theory algorithms with four candidates
	          and three heuristics} \label{tab:choice}
	\centering
